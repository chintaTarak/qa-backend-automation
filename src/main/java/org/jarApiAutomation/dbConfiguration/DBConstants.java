...
public class DBConstants {
    public static final String CHANGEJAR_MONGO_DB_URL =
            "mongodb+srv://staging-qa:rfyhBgx5CLm6jEVX@cluster0-pl-0.7kwfi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
    public static final String DIGIGOLD_MONGO_DB_URL =
            "mongodb://readOnly:GsKV2JPbL4ACU23@10.20.169.204:27017/digigold?authSource=digigold";
    public static final String TENANTS_MONGO_DB_URL =
            "mongodb://readUser:Z8V5VWBYSTxV78j@10.20.169.204:27017/tenants?authSource=tenants";
    public static final String POSTGRES_URL =
            "jdbc:postgresql://db-staging-transactions.cnduq5fakbez.ap-south-1.rds.amazonaws.com:5432";
    public static final String DIGIGOLDSDK_PG_URL = POSTGRES_URL + "/digigold_sdk";
    public static final String DIGIGOLD_PG_URL = POSTGRES_URL + "/digigold";
    public static final String DIGIGOLD_PG_USER = "master_read_user";
    public static final String DIGIGOLD_PG_PWD = "#9gIp)=72*";
