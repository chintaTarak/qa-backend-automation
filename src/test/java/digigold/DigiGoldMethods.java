...
public class DigiGoldMethods {
    ...
    public BuyPriceResponse buyPrice(Map<String, Object> queryParams, Map<String, String> headers)
    {
        ...
        BuyPriceResponse deserializedResponse = CommonSerializationUtil.readObject(response.getBody().asString(), BuyPriceResponse.class);
        deserializedResponse.setStatusCode(response.getStatusCode());
        return deserializedResponse;
    }

    public BuyVerifyResponse buyVerify(Map<String, String> headers, BuyVerifyRequest buyVerifyRequest)
    {
        RestRequest req=RestRequest.builder()
        ...
        BuyVerifyResponse deserializedResponse = CommonSerializationUtil.readObject(response.getBody().asString(), BuyVerifyResponse.class);
        deserializedResponse.setStatusCode(response.getStatusCode());
        return deserializedResponse;
    }

    public BuyConfirmResponse buyConfirm(Map<String, String> headers, BuyConfirmRequest buyConfirmRequest)
    {
        RestRequest req=RestRequest.builder()
                ...
                .build();
        Response response = apiRequests.post(req);
        BuyConfirmResponse deserializedResponse = CommonSerializationUtil.readObject(response.getBody().asString(), BuyConfirmResponse.class);
        deserializedResponse.setStatusCode(response.getStatusCode());
        return deserializedResponse;
    }

    public BuyStatusResponse buyStatus(Map<String, String> queryParams, Map<String, String> headers)
    {
        RestRequest req = RestRequest.builder()
                ...
                .build();
        Response response = apiRequests.get(req);
        BuyStatusResponse deserializedResponse = CommonSerializationUtil.readObject(response.getBody().asString(), BuyStatusResponse.class);
        deserializedResponse.setStatusCode(response.getStatusCode());
        return deserializedResponse;
    }

    public SellPriceResponse getSellPrice(Map<String, String> headers, Map<String, String> queryParams) {
        RestRequest req = RestRequest.builder()
                .url(getApiEndPoint(BaseUri.DIGIGOLD_BASE_URI, BaseUri.V1, DigiGoldEndpoints.GET_SELL_PRICE))
                .headers(headers)
                .queryParams(queryParams)
                .build();
        Response response = apiRequests.get(req);
        SellPriceResponse deserializedResponse = CommonSerializationUtil.readObject(response.getBody().asString(), SellPriceResponse.class);
        deserializedResponse.setStatusCode(response.getStatusCode());
        return deserializedResponse;
    }

    public SellVerifyResponse sellVerify(Map<String, String> headers, SellVerifyRequest sellVerifyRequest) {
        RestRequest req = RestRequest.builder()
                .url(getApiEndPoint(BaseUri.DIGIGOLD_BASE_URI, BaseUri.V1, DigiGoldEndpoints.SELL_VERIFY))
                .headers(headers)
                .body(sellVerifyRequest)
                .build();
        Response response = apiRequests.post(req);
        SellVerifyResponse deserializedResponse = CommonSerializationUtil.readObject(response.getBody().asString(), SellVerifyResponse.class);
        deserializedResponse.setStatusCode(response.getStatusCode());
        return deserializedResponse;
    }

    public SellConfirmResponse sellConfirm(Map<String, String> headers, SellConfirmRequest sellConfirmRequest) {
        RestRequest req = RestRequest.builder()
                .url(getApiEndPoint(BaseUri.DIGIGOLD_BASE_URI, BaseUri.V1, DigiGoldEndpoints.SELL_CONFIRM))
                .headers(headers)
                .body(sellConfirmRequest)
                .build();
        Response response = apiRequests.post(req);
        SellConfirmResponse deserializedResponse = CommonSerializationUtil.readObject(response.getBody().asString(), SellConfirmResponse.class);
        deserializedResponse.setStatusCode(response.getStatusCode());
        return deserializedResponse;
    }

    public SellStatusResponse sellStatus(Map<String, String> headers, Map<String , String> queryParam) {
        RestRequest req = RestRequest.builder()
                .url(getApiEndPoint(BaseUri.DIGIGOLD_BASE_URI, BaseUri.V1, DigiGoldEndpoints.SELL_STATUS))
                .headers(headers)
                .queryParams(queryParam)
                .build();
        Response response = apiRequests.get(req);
        SellStatusResponse deserializedResponse = CommonSerializationUtil.readObject(response.getBody().asString(), SellStatusResponse.class);
        deserializedResponse.setStatusCode(response.getStatusCode());
        return deserializedResponse;
    }
}
