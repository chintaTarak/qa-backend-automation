...
public class DigiGoldDataProvider {
    ...
    public Object[][] sellConfirm(ITestContext context) {
        ...
        return new Object[][] {
            // Invalid UserId
            {
                sellConfirmRequest("INVALID_USER_ID", orderId, MATERIAL_CODE, true),
                X_TENANT_INFO,
                400,
                USER_NOT_EXIST
            },
            // Invalid orderId
            {
                sellConfirmRequest(SELL_USER_ID, "INVALID_ORDER_ID", MATERIAL_CODE, true),
                X_TENANT_INFO,
                400,
                INVALID_ORDER_ID
            },
            ...
            {
                sellConfirmRequest(SELL_USER_ID, orderId, MATERIAL_CODE, true),
                null,
                400,
                ACCESS_DENIED
            },
    ...
    public Object[][] searchAllProducts() {
        return new Object[][] {
            // Happy Case
            {1, 30, X_TENANT_INFO_PRODUCT, 200, null},
            // Missing header
            {1, 30, null, 400, ACCESS_DENIED}
        };
    }
    ...
    public Object[][] getProductDetails() {
        return new Object[][] {
            // Happy Case
            {SKU_ID, X_TENANT_INFO_PRODUCT, 200, null},
            // Missing Header
            {SKU_ID, null, 400, ACCESS_DENIED}
        };
    }
}
