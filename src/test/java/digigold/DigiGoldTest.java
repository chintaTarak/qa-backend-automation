...
public class DigiGoldTest extends BaseTest {
    ...
    @Test(description = "Verify Create User API with valid and invalid scenarios", dataProvider = "userCreationScenarios", dataProviderClass = DigiGoldDataProvider.class,priority = 1)
